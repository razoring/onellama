    ...
    <div className="flex h-screen w-full overflow-hidden dark:bg-neutral-900">
      ...
      <main className="flex min-w-0 flex-1 flex-col transition-all duration-300">
        ...
        >
          {title && (
            <h1
              className={`${sidebarOpen ? "pl-6" : isWindows ? "pl-16" : "pl-36"} transition-[padding-left] duration-300 font-rounded text-md font-medium text-neutral-900 dark:text-white`}
            >
              {title}
            </h1>
          )}
